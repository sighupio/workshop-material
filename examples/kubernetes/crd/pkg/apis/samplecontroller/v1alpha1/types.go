...
// Pizza is a specification for a Pizza resource
type Pizza struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   PizzaSpec   `json:"spec"`
	Status PizzaStatus `json:"status"`
}

// PizzaSpec is the spec for a Pizza resource
...
// PizzaStatus is the status for a Pizza resource
...
// PizzaList is a list of Pizza resources
